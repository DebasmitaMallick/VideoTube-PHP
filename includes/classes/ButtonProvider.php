...
class ButtonProvider {
    ...
    public static function createUserProfileButton($con, $username) {
        ...
        return "<a id='profileBtn'><img src='$profilePic' class='profilePicture'></a>";
    }
    ...
    // ------------------------------delete button ------------------------------------
    public static function createDeleteVideoButton($videoId) {
        $href = "confirmDeleteVideo.php?videoId=$videoId";

        $button = ButtonProvider::createHyperlinkButton("DELETE VIDEO", null, $href, "delete button");

        return "<div class='deleteVideoButtonContainer'>
                    $button
                </div>";
    }
