...
class VideoProcessor {
    ...
    public function __construct($con) {
        ...
        // $this->ffmpegPath = "C:/xampp/htdocs/VideoTube_update/ffmpeg/windows/ffmpeg.exe";
        // $this->ffprobePath = "C:/xampp/htdocs/VideoTube_update/ffmpeg/windows/ffprobe.exe";
    }
    ...
    public function upload($videoUploadData) {
        ...
        if(move_uploaded_file($videoData["tmp_name"], $tempFilePath)) {
            ...
            if(!$this->generateThumbnails($finalFilePath, $videoUploadData->title)) {
    ...
    public function generateThumbnails($filePath, $title) {
        ...
        for($num = 1; $num <= $numThumbnails; $num++) {
            ...
            $query = $this->con->prepare("INSERT INTO thumbnails(videoId, filePath, selected, title)
                                        VALUES(:videoId, :filePath, :selected, :title)");
