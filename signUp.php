...
if(isset($_POST["submitButton"])) {
    ...
    $wasSuccessful = $account->register($firstName, $lastName, $username, $role, $number, $email, $email2, $password, $password2);

    if($wasSuccessful) {
        $_SESSION["userLoggedIn"] = $username;
        if(isset($_SESSION['previous-page'])){
            $pageRedirect = $_SESSION['previous-page'];
...
<body>
    ...
    <div class="signInContainer">
        ...
        <div class="column">
            ...
            <div class="header">
                <div id="headerTitle">
                    <img src="assets\images\icons\sanjivaniLogo.png" title="logo" alt="Site logo">Sanjivani
                </div>
                <p>Sign In to continue to Sanjivani</p>
            </div>
            <div class="loginForm">
                ...
                <!-------------------------------------- role field ------------------------------->
                <?php echo $account->getError(Constants::$roleInvalid); ?>
                ...
                <!-------------------------------------- phone number field ------------------------------->
                <?php echo $account->getError(Constants::$phoneNo); ?>
                <input type="text" name="PhoneNo" placeholder="Phone Number" autocomplete="off" value="<?php getInputValue('PhoneNo'); ?>" required>
